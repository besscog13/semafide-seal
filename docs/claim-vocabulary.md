...
| **Historical execution** | `historical_execution_established` | Does the record establish that this run happened as described, when it says? | The strongest claim the instrument makes. | Correct, fair, wise, or lawful. Those are never established. |
