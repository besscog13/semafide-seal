...
| **Recipe** | `recipe_available` | Does the record carry a complete re-run procedure, meaning endpoint, version, invocation, expected digest? | A stranger could attempt the re-run. | That anyone has. Until somebody executes it, it is a claim. |
